...
@section('content')
    <div class="bg-green-600 text-white text-center py-16">
        ...
        <div class="mt-12">
            <div class="relative">
                <a href="{{ route('recipes.generated') }}"
    ...
    <section class="bg-green-600 text-white text-center py-16">
        ...
        <a href="{{ route('recipes.generated') }}" class="bg-white text-green-600 font-semibold py-3 px-8 rounded-lg shadow hover:bg-gray-200 transition duration-300">
            Get Started Now
        </a>
    </section>
@endsection
